...
class WP_Customize_Range extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <label>
      ...
      <input onKeyUp="jQuery(this).prev('input').val( jQuery(this).val() )" type='number' min="<?php echo $this->min ?>" max="<?php echo $this->max ?>" step="<?php echo $this->step; ?>" value='<?php echo esc_attr( $this->value() ); ?>'>
    </label>
    <?php
  }
}
