  ...
  (function($) {
    wp.customize.bind('ready', function() {
      ...
      function sliderAutoVisible(val) {
        if (val === true) {
          jQuery("#customize-control-ctl_front_slider_auto_speed").removeClass('u-display__none');
        } else {
          jQuery("#customize-control-ctl_front_slider_auto_speed").addClass('u-display__none');
        }
      }

      wp.customize('front_slider_auto', function(value) {
