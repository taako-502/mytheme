<?php
namespace Mytheme_Theme\Customizer;
...
class Sanitize {
	...
	public static function get_sanitize_name( $type ) {
		...
		switch ( $type ) {
			case 'checkbox':
				return array( '\Mytheme_Theme\Customizer\Sanitize', 'checkbox' );
			case 'radio':
			case 'select':
				return array( '\Mytheme_Theme\Customizer\Sanitize', 'select' );
			case 'number':
				return array( '\Mytheme_Theme\Customizer\Sanitize', 'float' );
			case 'image':
