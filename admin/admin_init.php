...
$pc_psize = get_theme_mod_orDef('pc-p-size',$pc_psize_def);
$pc_h1size = get_theme_mod_orDef('pc-h1-size',$pc_h1size_def);
$pc_h2size = get_theme_mod_orDef('pc-h2-size',$pc_h2size_def);
$pc_h3size = get_theme_mod_orDef('pc-h3-size',$pc_h3size_def);
$pc_h4size = get_theme_mod_orDef('pc-h4-size',$pc_h4size_def);
$pc_h5size = get_theme_mod_orDef('pc-h5-size',$pc_h5size_def);
$pc_h6size = get_theme_mod_orDef('pc-h6-size',$pc_h6size_def);
$tb_psize = get_theme_mod_orDef('tb-p-size',$tb_psize_def);
$tb_h1size = get_theme_mod_orDef('tb-h1-size',$tb_h1size_def);
$tb_h2size = get_theme_mod_orDef('tb-h2-size',$tb_h2size_def);
$tb_h3size = get_theme_mod_orDef('tb-h3-size',$tb_h3size_def);
$tb_h4size = get_theme_mod_orDef('tb-h4-size',$tb_h4size_def);
$tb_h5size = get_theme_mod_orDef('tb-h5-size',$tb_h5size_def);
$tb_h6size = get_theme_mod_orDef('tb-h6-size',$tb_h6size_def);
$sm_psize = get_theme_mod_orDef('sm-p-size',$sm_psize_def);
$sm_h1size = get_theme_mod_orDef('sm-h1-size',$sm_h1size_def);
$sm_h2size = get_theme_mod_orDef('sm-h2-size',$sm_h2size_def);
$sm_h3size = get_theme_mod_orDef('sm-h3-size',$sm_h3size_def);
$sm_h4size = get_theme_mod_orDef('sm-h4-size',$sm_h4size_def);
$sm_h5size = get_theme_mod_orDef('sm-h5-size',$sm_h5size_def);
$sm_h6size = get_theme_mod_orDef('sm-h6-size',$sm_h6size_def);
